...
//  Using a for loop, loop over the passed in array IN REVERSE (
	// this means your counter should decrement), and then add each item to the 
...
// Then, use forEach to push each item's index from the myNumbers 
// array into the newly created myNumbersIndex array. 

// Code Here
// let myNumbersIndex = [];
// myNumbers.forEach(arr[i]){
//  return myNumbers.push(arr[i]);
// }
// let myNumbersIndex = [];
// myNumbers.forEach(function(element, index){
// myNumbersIndex.push(myNumbers[element, index]);
// })
var myNumbersIndex = [];
function index(myNumbers){
	for(i = 0; i < myNumbers.length; i++){
		 myNumbers.push(myNumbersIndex);
	}
	return myNumbersIndex[i];
}
// var myNumbersIndex = [];
...
// Code Here
// function trueFriends(friend){
// 	if (people.friend === true){
// 		return people.friend;
// 	}
// }
// const enemies = people.filter(function(i){
// 	if (people[i].friend === true){
// 		return enemies;
// 	}
// });
...
// Code Here
///this problem gave me an actual disease holy shit i just want you to know that
// people.reduce(function(total, element, index, array){
// 	var totallyAwesome =  total + people.awesomeLevel;
// 	return totallyAwesome;
// });
// return totallyAwesome;);

// var totallyAwesome = people[index].reduce(function(total, element, index){
// 	return total + people[idex].awesomeLevel;
// });

// var totallyAwesome = people.reduce((total, element) => {
// 	return total + people.element[awesomeLevel];
// )};
// people.forEach(function())

// var totallyAwesome = people.reduce(function(total, element, index){
// 	return total;
// })
