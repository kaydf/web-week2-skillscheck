...
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one parameter called 'item'. Add the item parameter to the end
//  of the groceries array created above. Inside of addItem, invoke displayData() 
// which is a function you did not create (we did) that takes care of some of the work for getting your page to display correctly.
...
// groceries in your groceries array using .length. Using an if/else statement, 
// check if the number of groceries is greater than or equal to 5. If it is, return the string 
// 'That looks like a big trip' from the function. If the number of groceries is equal to one, 
